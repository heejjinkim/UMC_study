...
public class StoreRestController {
    ...
    @PostMapping("/reviews")
    public ApiResponse<StoreResponseDTO.StoreResultDTO> join(@RequestBody @Valid StoreRequestDTO.StoreCreateDto request){
        Store store = storeService.joinStore(request);
        return ApiResponse.onSuccess(StoreConverter.toJoinResultDTO(store));
    }

    @PostMapping("/")
    public ApiResponse<ReviewResponseDTO.createResultDTO> join(@RequestBody @Valid StoreRequestDTO.ReviewCreateDto request){
